...
//        AppiumDriver driver = Base.driver;
    ...
    @And("Choose option {string} from bottom menu")
    public void chooseOptionFromBottomMenu(String option) throws Throwable {
        String xPath = "//*[contains(@resource-id,'main_bottom_nav_view')]"
                + "//*[contains(@content-desc,'" + option + "')]";
